...
variable "subnet_aks"         { type = string  default = "10.50.1.0/24" }
variable "subnet_appgw"       { type = string  default = "10.50.2.0/24" }
...
# AGIC / App Gateway
variable "appgw_sku"          { type = string  default = "WAF_v2" }
variable "appgw_capacity"     { type = number  default = 2 }
variable "appgw_public"       { type = bool    default = true } # public frontend; set false for private
variable "argocd_host"        { type = string  default = "argocd.corp.example.com" }
